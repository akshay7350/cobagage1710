<?php session_start();
include 'db/db.php';
 $sql = 'SELECT * FROM tbl_cob where email="'.$_SESSION['session'].'" ';
...
<head>
	...
	<title>Cobagage - My Cobagage</title>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <nav class="nav flex-column side-nav">
                              ...
                              <a class="nav-link active icon" href="my_cobagage.php">
                            ...
                            <div class="items list compact grid-xl-3-items grid-lg-2-items grid-md-2-items">
                                    ...
                                    <div class="item">
                                            <div class="wrapper">
                                                <div class="image">
                                                    <h3>
                                                        <a href="#" class="tag category">Cobagage</a>
                                                        <a href="single-listing-11.html" class="title"><?php echo $row['title'];?></a>
                                                       
                                                    </h3>
                                                    <a href="single-listing-11.html" class="image-wrapper background-image">
                                                        <img src="assets/img/coback.jpeg" alt="">
                                                    </a>
                                                </div>
                                                <!--end image-->
                                                <h4 class="location">
                                                    <a href="#">From: <?php echo $row['pick_up'];?></a>&nbsp;&nbsp;
                                                    <a href="#">To: <?php echo $row['drop_up'];?></a>
                                                </h4>
                                                <div class="price">$<?php echo $row['charges'];?></div>
                                                <div class="admin-controls">
                                                    <a href="edit_cobagage.php?id=<?php echo $row['id'];?>">
                                                        <i class="fa fa-pencil"></i>Edit
                                                    </a>
                                                   <!-- <a href="#" class="ad-hide">
                                                        <i class="fa fa-eye-slash"></i>Hide
                                                    </a>-->
                                                    <a href="delete_cobagage.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this item?');" class="delete-class">
                                                ...
                                                <div class="additional-info">
                                                    <ul>
                                                        <li>
                                                            ...
                                                            <aside><?php echo $row['s_date'];?></aside>
                                                        </li>
                                                        <li>
                                                                <figure>End Date</figure>
                                                                <aside><?php echo $row['e_date'];?></aside>
                                                        </li>
                                                        <li>
                                                            <figure>Carriage Capacity(in KG)</figure>
                                                            <aside><?php echo $row['capacity'];?></aside>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <!--end addition-info-->
