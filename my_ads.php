<?php session_start();
include 'db/db.php';
 $sql = 'SELECT * FROM items where email="'.$_SESSION['session'].'" ';
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <nav class="nav flex-column side-nav">
                                ...
                                <a class="nav-link active icon" href="my_ads.php">
                               ...
                               <?php  while($row = mysqli_fetch_array($retval)) {?>
                                <div class="item">
                                    ...
                                    <div class="wrapper">
                                        <div class="image">
                                            <h3>
                                                <a href="#" class="tag category">Article</a>
                                                <a href="single-listing-1.html" class="title"><?php echo $row['title'];?></a>
                                                <span class="badge">Quantity      <?php echo $row['qty'];?></span>
                                            </h3>
                                        ...
                                        <div class="admin-controls">
                                            <a href="edit_ads.php?id=<?php echo $row['id'];?>">
                                                <i class="fa fa-pencil"></i>Edit
                                            </a>
                                            <a href="" class="ad-hide">
                                                <i class="fa fa-eye-slash"></i>Hide
                                            </a>
                                            <a href="delete_article.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this item?');" class="delete-class">
                                        ...
                                        <!--end description-->
                                        <a href="#" class="detail text-caps underline">View</a>
                                    </div>
                                </div>
                                <!--end item-->
