...
$id=$_GET['id'];
 ...
 $sql_edit_donation = 'SELECT * FROM tbl_donation where id="'.$id.'" ';
  
   $retval = mysqli_query($conn,$sql_edit_donation);
...
{    
    ...
    $email=  $_SESSION['session'];
     ...
     $sql2 = "UPDATE tbl_donation SET title='$title',category='$cat',qty='$qty',slugs='$slugs',location='$location',description='$description' where id='$id' and email='$email'";
  ...
  Record Updated Successfully.....!
        ...
        header( "refresh:2; url=my_donation.php" ); 
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input name="price" type="text" class="form-control" value="<?php echo $row['price'];?>" id="price" required="" readonly>
                                   ...
                                   $s="select * from category";
                                    ...
                                    <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="article___other_details" class="form-control" rows="4">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <input name="location" type="text" class="form-control" value="<?php echo $row['location'];?>" id="input-location" placeholder="Enter Location">
